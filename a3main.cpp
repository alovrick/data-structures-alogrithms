...
int main(void){
	...
	if((recordTree.begin() != recordTree.end()) || (largeDataTree.begin() != largeDataTree.end()) || exampleTree.begin() != exampleTree.end() ||
		...
		cout << "Error 1: check the constructor, begin()/cbegin() and end()/cend(), == and != functions" << endl;
		passtest=false;
	}
	if(passtest){
		numPassed++;
		...
		for(int i=0;isGood && i < 9;i++){
			...
			if(intIterator1==exampleTree.end() || *intIterator1 != exampleData[i]){
				...
				if(intIterator1 == exampleTree.end()){
					...
					cout << "the node returned by the iterator contains: " << *intIterator1 << endl;
				}
			}
			if(cintIterator1==exampleTree.cend() || *cintIterator1 != exampleData[i]){
				...
				if(cintIterator1 == exampleTree.cend()){
					...
					cout << "the node returned by the iterator contains: " << *cintIterator1 << endl;
				}
			}
		}
		for(int i=0;isGood && i < 20;i++){
			...
			if(recIterator1==recordTree.end() || *recIterator1 != recordData[i]){
				...
				if(recIterator1 == recordTree.end()){
					...
					cout << "the node returned by the iterator contains: " << *recIterator1 << endl;
				}
			}
			if(crecIterator1==recordTree.cend() || *crecIterator1 != recordData[i]){
				...
				if(crecIterator1 == recordTree.cend()){
					...
					cout << "the node returned by the iterator contains: " << *crecIterator1 << endl;
				}
			}
		}
		for(int i=0;isGood && i < numLarge;i++){
			...
			if(intIterator1==largeDataTree.end() || *intIterator1 != largeData[i]){
				...
				if(intIterator1 == largeDataTree.end()){
					cout << "Index: " << i << " Function returned end() when it should have returned iterator to the node"  << endl;
				}
				else{
					cout << "the node returned by the iterator contains: " << *intIterator1 << endl;
				}
	...
	if(passtest){
		...
		while(isGood && i < 9){
			if(*intIterator1 != exampleOrdered[i]){
				isGood=false;
				cout << "Error 3a: iterator is not going through the tree correctly" << endl;
	
				#if VERBOSE >= 1
				auto it=exampleTree.begin();
				cout << "The following is a listing of the result vs expected" << endl;
				cout << "result  --->   correct value"  << endl;
			...
			if(*cintIterator1 != exampleOrdered[i]){
				isGood=false;
				cout << "Error 3b: const_iterator is not going through the tree correctly" << endl;
				#if VERBOSE >= 1
			...
			if(*intIterator2 != exampleOrdered[i]){
				isGood=false;
				cout << "Error 3c: the postfix ++ operator is not returning the correct value" << endl;
			}
			if(*cintIterator2 != exampleOrdered[i]){
				isGood=false;
				cout << "Error 3d: the postfix ++ operator is not returning the correct value" << endl;
			}
			i++;
		}
		if(isGood){
			if(cintIterator1 != exampleTree.cend() || intIterator1 != exampleTree.end()){
				cout << "Error 3e: (const_)iterator is not going through the tree correctly" << endl;
		...
		while(isGood && i < 20){
			if(*recIterator1 != orderedRecords[i]){
				isGood=false;
				cout << "Error 3f: iterator is not going through the tree correctly" << endl;
			...
			if(*crecIterator1 != orderedRecords[i]){
				isGood=false;
				cout << "Error 3g: const_iterator is not going through the tree correctly" << endl;
				#if VERBOSE >= 1
			...
			if(*recIterator2 != orderedRecords[i]){
				isGood=false;
				cout << "Error 3h: the postfix ++ operator is not returning the correct value" << endl;
			}
			if(*crecIterator2 != orderedRecords[i]){
				isGood=false;
				cout << "Error 3i: the postfix ++ operator is not returning the correct value" << endl;
			}
			i++;
		}
		...
		if(isGood){
			if(crecIterator1 != recordTree.cend() || recIterator1 != recordTree.end()){
				cout << "Error 3j: (const_)iterator is not going through the tree correctly" << endl;
				cout << "(const_)iterator should be end()/cend()"  << endl;
				isGood=false;
			}
		}
		...
		while(isGood && i < numLarge){
			if(*intIterator1 != largeDataOrdered[i]){
				isGood=false;
				cout << "Error 3k: iterator is not going through the tree correctly" << endl;
			...
			if(*cintIterator1 != largeDataOrdered[i]){
				isGood=false;
				cout << "Error 3l: const_iterator is not going through the tree correctly" << endl;
				#if VERBOSE > 1
			...
			if(*intIterator2 != largeDataOrdered[i]){
				isGood=false;
				cout << "Error 3m: the postfix ++ operator is not returning the correct value" << endl;
			}
			if(*cintIterator2 != largeDataOrdered[i]){
				isGood=false;
				cout << "Error 3n: the postfix ++ operator is not returning the correct value" << endl;
			}
			i++;
		}
		...
		if(isGood){
			if(cintIterator1 != largeDataTree.cend() || intIterator1 != largeDataTree.end()){
				cout << "Error 3o: (const_)iterator is not going through the tree correctly" << endl;
				cout << "(const_)iterator should be end()/cend()"  << endl;
				isGood=false;
			}
		}
	...
	if(passtest){
		...
		while(isGood && i < 9){
			if(*intIterator1 != exampleOrdered[i]){
				isGood=false;
				cout << "Error 4a: iterator is not going through the tree correctly" << endl;
			...
			if(*cintIterator1 != exampleOrdered[i]){
				isGood=false;
				cout << "Error 4b: const_iterator is not going through the tree correctly" << endl;
				#if VERBOSE >= 1
				auto it=exampleTree.cbegin();
				cout << "The following is a listing of the result vs expected" << endl;
				cout << "result  --->   correct value"  << endl;
			...
			if(*intIterator2 != exampleOrdered[i]){
				isGood=false;
				cout << "Error 4c: the prefix ++ operator is not returning the correct value" << endl;
			}
			if(*cintIterator2 != exampleOrdered[i]){
				isGood=false;
				cout << "Error 4d: the prefix ++ operator is not returning the correct value" << endl;
			}
			i++;
			cintIterator2=++cintIterator1;
			intIterator2=++intIterator1;
		...
		if(isGood){
			if(cintIterator1 != exampleTree.cend() || intIterator1 != exampleTree.end()){
				cout << "Error 4e: (const_)iterator is not going through the tree correctly" << endl;
				cout << "(const_)iterator should be end()/cend()"  << endl;
				isGood=false;
			}
		}
		...
		while(isGood && i < 20){
			if(*recIterator1 != orderedRecords[i]){
				isGood=false;
				cout << "Error 4f: iterator is not going through the tree correctly" << endl;
			...
			if(*crecIterator1 != orderedRecords[i]){
				isGood=false;
				cout << "Error 4g: const_iterator is not going through the tree correctly" << endl;
				#if VERBOSE >= 1
				auto it=recordTree.cbegin();
				cout << "The following is a listing of the result vs expected" << endl;
				cout << "result  --->   correct value"  << endl;
			...
			if(*recIterator2 != orderedRecords[i]){
				isGood=false;
				cout << "Error 4h: the prefix ++ operator is not returning the correct value" << endl;
			}
			if(*crecIterator2 != orderedRecords[i]){
				isGood=false;
				cout << "Error 4i: the prefix ++ operator is not returning the correct value" << endl;
			}
			crecIterator2=++crecIterator1;
			recIterator2=++recIterator1;
			i++;
		...
		if(isGood){
			if(crecIterator1 != recordTree.cend() || recIterator1 != recordTree.end()){
				cout << "Error 4j: (const_)iterator is not going through the tree correctly" << endl;
				cout << "(const_)iterator should be end()/cend()"  << endl;
				isGood=false;
			}
		}
		...
		while(isGood && i < numLarge){
			if(*intIterator1 != largeDataOrdered[i]){
				isGood=false;
				cout << "Error 4k: iterator is not going through the tree correctly" << endl;
			...
			if(*cintIterator1 != largeDataOrdered[i]){
				isGood=false;
				cout << "Error 4l: const_iterator is not going through the tree correctly" << endl;
				#if VERBOSE > 1
				auto it=largeDataTree.cbegin();
				cout << "The following is a listing of the result vs expected" << endl;
				cout << "result  --->   correct value"  << endl;
			...
			if(*intIterator2 != largeDataOrdered[i]){
				isGood=false;
				cout << "Error 4m: the prefix ++ operator is not returning the correct value" << endl;
			}
			if(*cintIterator2 != largeDataOrdered[i]){
				isGood=false;
				cout << "Error 4n: the prefix ++ operator is not returning the correct value" << endl;
			}
			cintIterator2=++cintIterator1;
			intIterator2=++intIterator1;
			i++;
	...
	if(passtest){
		...
		while(isGood && i > 0){
			...
			if(*intIterator1 != exampleOrdered[i]){
				isGood=false;
				cout << "Error 5a: prefix -- operator is not going through the tree correctly" << endl;
			...
			if(*cintIterator1 != exampleOrdered[i]){
				isGood=false;
				cout << "Error 5b: prefix -- operator is not going through the tree correctly" << endl;
				#if VERBOSE >= 1
				auto it=exampleTree.cbegin();
				cout << "The following is a listing of the result vs expected" << endl;
				cout << "result  --->   correct value"  << endl;
			...
			if(*intIterator2 != exampleOrdered[i]){
				isGood=false;
				cout << "Error 5c: the prefix -- operator is not returning the correct value" << endl;
			}
			if(*cintIterator2 != exampleOrdered[i]){
				isGood=false;
				cout << "Error 5d: the prefix -- operator is not returning the correct value" << endl;
			}

		}
		if(isGood){
			if(cintIterator1 != exampleTree.cbegin() || intIterator1 != exampleTree.begin()){
				cout << "Error 5e: (const_)iterator is not going through the tree correctly" << endl;
		...
		while(isGood && i >0){
			...
			if(*recIterator1 != orderedRecords[i]){
				isGood=false;
				cout << "Error 5f: iterator is not going through the tree correctly" << endl;
			...
			if(*crecIterator1 != orderedRecords[i]){
				isGood=false;
				cout << "Error 5g: const_iterator is not going through the tree correctly" << endl;
				#if VERBOSE >= 1
				auto it=recordTree.cbegin();
				cout << "The following is a listing of the result vs expected" << endl;
				cout << "result  --->   correct value"  << endl;
			...
			if(*recIterator2 != orderedRecords[i]){
				isGood=false;
				cout << "Error 5h: the prefix -- operator is not returning the correct value" << endl;
			}
			if(*crecIterator2 != orderedRecords[i]){
				isGood=false;
				cout << "Error 5i: the prefix -- operator is not returning the correct value" << endl;
			}
		...
		if(isGood){
			if(crecIterator1 != recordTree.cbegin() || recIterator1 != recordTree.begin()){
				cout << "Error 5j: (const_)iterator is not going through the tree correctly" << endl;
				cout << "(const_)iterator should be begin()/cbegin()"  << endl;
				isGood=false;
			}
		}
		...
		while(isGood && i > 0){
			...
			if(*intIterator1 != largeDataOrdered[i]){
				isGood=false;
				cout << "Error 5k: iterator is not going through the tree correctly" << endl;
			...
			if(*cintIterator1 != largeDataOrdered[i]){
				isGood=false;
				cout << "Error 5l: const_iterator is not going through the tree correctly" << endl;
				#if VERBOSE > 1
			...
			if(*intIterator2 != largeDataOrdered[i]){
				isGood=false;
				cout << "Error 5m: the prefix -- operator is not returning the correct value" << endl;
			}
			if(*cintIterator2 != largeDataOrdered[i]){
				isGood=false;
				cout << "Error 5n: the prefix -- operator is not returning the correct value" << endl;
			}
		...
		if(isGood){
			if(cintIterator1 != largeDataTree.cbegin() || intIterator1 != largeDataTree.begin()){
				cout << "Error 5o: (const_)iterator is not going through the tree correctly" << endl;
				cout << "(const_)iterator should be begin()/cbegin()"  << endl;
				isGood=false;
			}
		}
	...
	if(passtest){
		...
		while(isGood && i > 0){
			...
			if(*intIterator1 != exampleOrdered[i]){
				isGood=false;
				cout << "Error 6a: postfix -- operator is not going through the tree correctly" << endl;
			...
			if(*cintIterator1 != exampleOrdered[i]){
				isGood=false;
				cout << "Error 6b: postfix -- operator is not going through the tree correctly" << endl;
				#if VERBOSE >= 1
				auto it=exampleTree.cbegin();
				cout << "The following is a listing of the result vs expected" << endl;
				cout << "result  --->   correct value"  << endl;
			...
			if(i < 8){
				if(*intIterator2 != exampleOrdered[i+1]){
					isGood=false;
					cout << "Error 6c: the postfix -- operator is not returning the correct value" << endl;
				}
				if(*cintIterator2 != exampleOrdered[i+1]){
					isGood=false;
					cout << "Error 6d: the postfix -- operator is not returning the correct value" << endl;
				}
			}
			else{
		...
		if(isGood){
			if(cintIterator1 != exampleTree.cbegin() || intIterator1 != exampleTree.begin()){
				cout << "Error 6e: (const_)iterator is not going through the tree correctly" << endl;
				cout << "(const_)iterator should be begin()/cbegin()"  << endl;
				isGood=false;
			}
		}
		...
		while(isGood && i >0){
			...
			if(*recIterator1 != orderedRecords[i]){
				isGood=false;
				cout << "Error 6f: iterator is not going through the tree correctly" << endl;
			...
			if(*crecIterator1 != orderedRecords[i]){
				isGood=false;
				cout << "Error 6g: const_iterator is not going through the tree correctly" << endl;
				#if VERBOSE >= 1
				auto it=recordTree.cbegin();
				cout << "The following is a listing of the result vs expected" << endl;
				cout << "result  --->   correct value"  << endl;
			...
			if(i < recCap-1){
				if(*recIterator2 != orderedRecords[i+1]){
					isGood=false;
					cout << "Error 6h: the postfix -- operator is not returning the correct value" << endl;
				}
				if(*crecIterator2 != orderedRecords[i+1]){
					isGood=false;
					cout << "Error 6i: the postfix -- operator is not returning the correct value" << endl;
				}
			}
			else{
		...
		if(isGood){
			if(crecIterator1 != recordTree.cbegin() || recIterator1 != recordTree.begin()){
				cout << "Error 6j: (const_)iterator is not going through the tree correctly" << endl;
				cout << "(const_)iterator should be begin()/cbegin()"  << endl;
				isGood=false;
			}
		}
		...
		while(isGood && i > 0){
			...
			if(*intIterator1 != largeDataOrdered[i]){
				isGood=false;
				cout << "Error 6k: iterator is not going through the tree correctly" << endl;
			...
			if(*cintIterator1 != largeDataOrdered[i]){
				isGood=false;
				cout << "Error 6l: const_iterator is not going through the tree correctly" << endl;
				#if VERBOSE > 1
				auto it=largeDataTree.cend();
				cout << "The following is a listing of the result vs expected" << endl;
				cout << "result  --->   correct value"  << endl;
		...
		if(isGood){
			if(cintIterator1 != largeDataTree.cbegin() || intIterator1 != largeDataTree.begin()){
				cout << "Error 6o: (const_)iterator is not going through the tree correctly" << endl;
				cout << "(const_)iterator should be begin()/cbegin()"  << endl;
				isGood=false;
			}
		}
 	...
 	if(numPassed == 6){
		...
		cout << numPassed << " / 6 tests passed.  Looks like I still" << endl;
